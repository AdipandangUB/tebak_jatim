...
if not st.session_state.name_submitted:
    ...
    with col2:
        ...
        st.markdown(
            "<div style='text-align:center;margin:20px 0;'><h1>🧩 Sepiro mudenge soal kutha karo kabupaten ning Jawa Timur? - Pengetahuan Tentang Kota & Kabupaten di Jawa Timur</h1>"
